...
<body>
	...
	<div class="container">
		...
		<div class="main_contents">
			<div id="sub_content">
				<form:form action="/student_registeration/editstudent" method="post" modelAttribute="student">
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<form:select class="form-select" path="educations" aria-label="Education">
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							...
							<a href="/student_registeration/deletestudent/${student.id}">
