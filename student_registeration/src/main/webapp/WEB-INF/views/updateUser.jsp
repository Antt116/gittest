...
<body>
	...
	<div class="container">
		...
		<div class="main_contents">
			<div id="sub_content">
				<form:form action="/student_registeration/edituser" method="post" modelAttribute="user">
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<form:input type="password" class="form-control"
								path="confirmPassword" value="09090293"></form:input>
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-md-2"></div>
					...
					<div class="row mb-4">
						...
						<div class="col-md-6">
							...
							<button type="button" class="btn btn-secondary col-md-2 "
								onclick="location.href = 'USR003.html';">Back</button>
